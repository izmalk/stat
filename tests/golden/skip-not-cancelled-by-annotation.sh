#!/bin/bash
# Extracted from : tests/fixtures/skip-not-cancelled-by-annotation.md
# Regenerate with: python3 extract_commands.py tests/fixtures/skip-not-cancelled-by-annotation.md <output.sh>
#
